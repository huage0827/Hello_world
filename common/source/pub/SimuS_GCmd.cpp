/*****************************************************************
 * 文件名: SimuS_GCmd.cpp
 * 功能: SimuService和SimuGuard之间通信命令实现
 *
 *****************************************************************/
#include "stdafx.h"
...
/*****************************************************************
 *  函数名：	CSimuS_GCmd::CSimuS_GCmd
 *  功能：		SimuService和SimuGuard之间通信的所有命令的父类构造函数
 *  入参:		S_G_CMD sgc -- 命令字
 *  出参:		无
 *  返回值:		无
 *****************************************************************/
...
/*****************************************************************
 *  函数名：	CSimuS_GCmd::~CSimuS_GCmd
 *  功能：		SimuService和SimuGuard之间通信的所有命令的父类析构函数
 *  入参:		S_G_CMD sgc -- 命令字
 *  出参:		无
 *  返回值:		无
 *****************************************************************/
...
/*****************************************************************
 *  函数名：CSimuS_GCmd::PreParseCmd
 *  功能：  预解析数据 , 获得响应的命令
 *  入参:   unsigned char* szBuffer -- 数据缓冲区
 *			unsigned long nBufferLen -- 数据缓冲区长度
 *  出参:	unsigned long& nCmdDataLen -- 命令实际的长度
 *  返回值:	预解析获得的命令字
 *****************************************************************/
...
/*****************************************************************
 *  函数名：CSimuS_GCmd::SetSimuProjectID
 *  功能：  设置该命令所属的仿真工程ID号
 *  入参:   const char* szId -- 仿真工程ID号
 *  出参:	无
 *  返回值:	无
 *****************************************************************/
...
/*****************************************************************
 *  函数名：CSimuS_GCmd::GetFrameBodyLen
 *  功能：  获取命令帧体长度
 *  入参:   无
 *  出参:	无
 *  返回值:	命令帧体长度
...
/*****************************************************************
 *  函数名：CSimuS_GCmd::GetSimuProjectID
 *  功能：  获取该命令所属的仿真工程ID号
 *  入参:   无
 *  出参:	char* szId -- 命令所属的仿真工程ID号
 *  返回值:	无
 *****************************************************************/
...
/*****************************************************************
 *  函数名：CSimuS_GCmd::SerializeHeader
 *  功能：  序列化命令帧头
 *  入参:   无
...
/*****************************************************************
 *  函数名：CSimuS_GCmd::Unserialize
 *  功能：  反序列化传入的数据
 *  入参:   unsigned char* szBuffer -- 需要反序列化的数据缓冲区
 *			unsigned long nBufferLen -- 需要反序列化的数据缓冲区大小
 *  出参:	无
